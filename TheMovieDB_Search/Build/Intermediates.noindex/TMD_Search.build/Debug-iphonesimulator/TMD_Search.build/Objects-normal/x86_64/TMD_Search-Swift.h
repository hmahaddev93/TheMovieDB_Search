...
#ifndef TMD_SEARCH_SWIFT_H
#define TMD_SEARCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TMD_Search",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10TMD_Search11AppDelegate")
...
SWIFT_CLASS("_TtC10TMD_Search9MovieCell")
...
SWIFT_CLASS("_TtC10TMD_Search10MovieLabel")
...
SWIFT_CLASS("_TtC10TMD_Search9MovieView")
...
SWIFT_CLASS("_TtC10TMD_Search20MoviesViewController")
...
@interface MoviesViewController (SWIFT_EXTENSION(TMD_Search)) <UITableViewDelegate>
@end

@class UISearchBar;

@interface MoviesViewController (SWIFT_EXTENSION(TMD_Search)) <UISearchBarDelegate>
...
@interface MoviesViewController (SWIFT_EXTENSION(TMD_Search)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC10TMD_Search13SceneDelegate")
