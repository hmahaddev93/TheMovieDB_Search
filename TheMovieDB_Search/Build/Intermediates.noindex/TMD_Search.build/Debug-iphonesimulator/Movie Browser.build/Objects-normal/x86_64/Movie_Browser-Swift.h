...
#ifndef MOVIE_BROWSER_SWIFT_H
#define MOVIE_BROWSER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Movie_Browser",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Movie_Browser11AppDelegate")
...
SWIFT_CLASS("_TtC13Movie_Browser9MovieCell")
...
SWIFT_CLASS("_TtC13Movie_Browser10MovieLabel")
@interface MovieLabel : UILabel
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC13Movie_Browser9MovieView")
...
SWIFT_CLASS("_TtC13Movie_Browser20MoviesViewController")
...
@interface MoviesViewController (SWIFT_EXTENSION(Movie_Browser)) <UITableViewDelegate>
@end

@class UISearchBar;

@interface MoviesViewController (SWIFT_EXTENSION(Movie_Browser)) <UISearchBarDelegate>
...
@interface MoviesViewController (SWIFT_EXTENSION(Movie_Browser)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC13Movie_Browser13SceneDelegate")
